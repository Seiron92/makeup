...
/* ON "ARROW" CLICK SCROLL DOWN TO CONTENT */
arrow.onclick = function () {
    var middle =  document.getElementById('middle');
    middle.style.marginTop = '10vh';
    document.getElementById('middle').scrollIntoView({ block: 'start',  behavior: 'smooth' });
};
arrow2.onclick = function () {
    var middle =  document.getElementById('middle');
    middle.style.marginTop = '-18vh';
    middle.style.paddingBottom = '200px';
    document.getElementById('middle').scrollIntoView({ block: 'start',  behavior: 'smooth' });
    var top = document.getElementById('top')
