...
var arrows = document.getElementById('wrapper');
    ...
    if (buyIt != '') {
        ...
        buyIt.forEach(function (key) {
            ...
            inside.innerHTML += '<div class="products">' +
                ...
                '<p class="number">Antal:</p> <input class="numbers" type"text" value="' + antalprodukter + '"</input><div class="minus">Ta bort produkt</div>' + '</div>';
        }) 
    } else {
...
if(buyIt != ''){
    console.log(save)
                for (var ia = 0; ia < save.length; ia++){
                    for (var i = 0; i < buyIt.length; i++) {
                        if (save[ia].underrub == buyIt[i].underrub) {
                       ...
                       var antlpr = document.getElementsByClassName('numbers');
           for(var i = 0; i < antlpr.length; i++){
            antlpr[i].value = parseInt(buyIt[i].antalprodukter) + parseInt(save[ia].antalprodukter);
           }
                        ...
                        '<div class="img">' + produktBild + '</div>' +
                        '<p class="sum">' + pris + '</p><p class="sumfill"> kr</p>' +
                        '<p class="number">Antal:</p> <input class="numbers" type"text" value="' + antalprodukter + '"</input><button class="minus">Ta bort produkt</button>' + '</div>';
                }) 
                    }
                }
...
if(buyIt != ''){
                for (var i = 0; i < save.length; i++){
                    for (var i = 0; i < buyIt.length; i++) {
                        if (save[i].underrub == buyIt[i].underrub) {
                       ...
                       var antlpr = document.getElementsByClassName('numbers');
           for(var i = 0; i < antlpr.length; i++){
            antlpr[i].value = parseInt(buyIt[i].antalprodukter) + parseInt(save[i].antalprodukter);
           }
...
var conf = document.getElementById('conf')
    ...
    tabort.onclick = function () {
     ...
     conf.style.display = 'block';
        conf.innerHTML = '<div class="doyou"> <div class="dotext"><p>Vill du verkligen tömma kassan?</p></div>' + 
...
checkout.onclick = function () {
    ...
    if (fnames.value == '') {
        ...
        postnummer.focus();
        postnummer.placeholder = 'Fyll i ditt postnummer'
    }
    else if (stad.value == '') {
        stad.focus();
        ...
        emailsc.focus();
        emailsc.placeholder = 'Fyll i din epost'
    }
    else if (telefon.value == '') {
        telefon.focus();
        telefon.placeholder = 'Fyll i ditt telefonnummer'
    } else {
        var timer = null;
        window.clearTimeout(timer);
        timer = window.setTimeout(function () {
